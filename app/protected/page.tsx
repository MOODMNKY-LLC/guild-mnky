    ...
    <div className="flex flex-1 flex-col gap-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            <CardTitle>Welcome to Jupiter's Girth</CardTitle>
            <CardDescription>
              Your community dashboard and coordination hub
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Hello, <span className="font-medium">{data.claims.email}</span>! 
              Welcome to your community dashboard. Use the sidebar to navigate 
              to different sections of the community OS.
            </p>
          </CardContent>
        </Card>
        <Card className="col-span-3">
          ...
          <CardContent>
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Quick actions will be available here soon.
              </p>
            </div>
          </CardContent>
        </Card>
